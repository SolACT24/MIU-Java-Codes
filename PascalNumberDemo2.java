...
For example 6 is a Pascal number because 6 = 1 + 2 + 3. Here j is 3. Another Pascal number is 15 because 15 = 1 + 2 + 3 + 4 + 5. 
An example of a number that is not a Pascal number is 7 because it falls between the Pascal numbers 6 and 10.
...
The signature of the function is:
   int isPascal(int n)
*/
public class PascalNumberDemo2 
{
