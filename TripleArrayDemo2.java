...
The following arrays are not Triple arrays {2, 5, 2, 5, 5, 2, 5} (5 occurs four times instead of three times), {3, 1, 1, 1} (3 occurs once instead of three times)
...
If you are programming in Java or C#, the function signature is
   int isTriple(int[] a)
*/
public class TripleArrayDemo2 //Perfect Answer!!!!
{
    ...
    static int isTriple(int[] a)
    {
        ...
        { 
            ...
            for(int j = 0; j < a.length; j++)
                if(a[i] == a[j]) freq++;
            //System.out.println(a[i]+", freq: "+freq);
            if(freq != 3) return 0; 
        }
        return 1;
    }
