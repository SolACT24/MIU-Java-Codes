 ...
 So, for instance, 6936 = 2*2*2*3*17*17. Write a method named encodeNumber what will encode a number n as an array that contains the prime numbers that, 
 when multipled together, will equal n. So encodeNumber(6936) would return the array {2, 2, 2, 3, 17, 17}. If the number is <= 1 the function should return null; 
 ...
 */
 ...
 public class EncodeNumberDemo3 //Perfect Answer
 {
     public static void main(String[] args) 
     {
        ...
        System.out.println(Arrays.toString(encodeNumber(-18))); //null
        System.out.println(Arrays.toString(encodeNumber(6936))); //{2, 2, 2, 3, 17, 17}
     }
