...
the method returns 1 if its array parameter is n-primeable; otherwise it returns 0.
...
*/
public class NPrimeableDemo2 //Perfect Answer!
{
    public static void main(String[] args)
    {
        System.out.println(isNPrimeable(new int[] {5, 15, 27}, 2)); //1
        System.out.println(isNPrimeable(new int[] {5, 15, 27}, 3)); //0
        System.out.println(isNPrimeable(new int[] {5, 15, 26}, 2)); //0
        System.out.println(isNPrimeable(new int[] {1, 1, 1, 1, 1, 1, 1}, 4)); //1
        System.out.println(isNPrimeable(new int[] {}, 2)); //1
        System.out.println(isNPrimeable(new int[] {}, 4)); //0
    }
    static int isNPrimeable(int[] a, int n)
    {
        //if(a.length == 0 && isPrime(n) == true) return 1; //This line of code is not necessary as the end line of code returns 1!
        if(a.length == 0 && isPrime(n) == false) return 0;

        for(int i = 0; i < a.length; i++)
            if(isPrime(a[i]+n) == false) return 0;
        return 1;
    }
