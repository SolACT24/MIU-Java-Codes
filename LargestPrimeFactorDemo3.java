...
*/
public class LargestPrimeFactorDemo3 //Perfect Answer!
{
    public static void main(String args[]) 
    {
        ...
        //System.out.println();      
        System.out.println(largestPrimeFactor(12)); //3
        System.out.println(largestPrimeFactor(18)); //3
        System.out.println(largestPrimeFactor(19)); //19
        System.out.println(largestPrimeFactor(24)); //3
        System.out.println(largestPrimeFactor(20)); //5
        System.out.println(largestPrimeFactor(92)); //23
