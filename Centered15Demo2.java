/* An array is called centered-15 if some consecutive sequence of elements of the array sum to 15 and this sequence is preceded and 
followed by the same number of elements.  For example 
{3, 2, 10, 4, 1, 6, 9} is centered-15 because  the sequence 10, 4, 1 sums to 15 and the sequence is preceded by two elements (3, 2) and 
followed by two elements(6,9).
...
public class Centered15Demo2
{
    ...
    static int isCentered15(int[] a)
    {
        for(int i = 0; i < a.length; i++)
        {
            ...
            if(sum == 15 && i == (a.length-1) - j) return 1;
        }
        return 0;
    }
}
